...
exports.getCartProduct = async (req, res) => {
  try {
    ...
    const [user, cart] = await Promise.all([User.findById(req.query.userId), Cart.findOne({ userId: req.query.userId })]);
...
exports.deleteCart = async (req, res) => {
  try {
    ...
    const [user, cartByUser] = await Promise.all([User.findById(req.query.userId), Cart.findOne({ userId: req.query.userId })]);

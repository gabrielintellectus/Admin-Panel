...
route.patch(
  "/acceptCreateRequest",
  checkAccessWithSecretKey(),
  ProductController.acceptCreateRequest
);

//get status wise all product requests to create product for admin panel
route.get(
  "/createProductRequestStatusWise",
  checkAccessWithSecretKey(),
  ProductController.createProductRequestStatusWise
);
...
route.get(
  "/detailforSeller",
  checkAccessWithSecretKey(),
  ProductController.detailforSeller
);
...
route.patch(
  "/selectOrNot",
  checkAccessWithSecretKey(),
  ProductController.selectedOrNot
);
...
route.get(
  "/selectedProducts",
  checkAccessWithSecretKey(),
  ProductController.getSelectedProducts
);
...
route.post(
  "/filterWiseProduct",
  checkAccessWithSecretKey(),
  ProductController.filterWiseProduct
);
...
route.patch(
  "/isOutOfStock",
  checkAccessWithSecretKey(),
  ProductController.isOutOfStock
);
...
route.patch(
  "/isNewCollection",
  checkAccessWithSecretKey(),
  ProductController.isNewCollection
);
...
route.get(
  "/geAllNewCollection",
  checkAccessWithSecretKey(),
  ProductController.getAllisNewCollection
);
...
route.get(
  "/getRealProducts",
  checkAccessWithSecretKey(),
  ProductController.getRealProducts
);
...
route.get(
  "/getFakeProducts",
  checkAccessWithSecretKey(),
  ProductController.getFakeProducts
);
...
route.get(
  "/getSellerWise",
  checkAccessWithSecretKey(),
  ProductController.getSellerWise
);
